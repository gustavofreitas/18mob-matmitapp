 ...
 * [SelectedProductFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [SelectedProductFragment.newInstance] factory method to
...
class SelectedProductFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment SelectedProductFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            SelectedProductFragment().apply {
